                ...
                <div class="card-body p-3">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-5">
                            <div id="map" class="mt-0 mt-lg-n4 jvm-container"><svg width="1103" height="259">
                                    <defs></defs>
                                    <g id="jvm-regions-group"
                                        transform="scale(0.4441927145890737) translate(791.5782201880486, 0)">
                                        <path
                                        ...
                                        <path
                                            ...
                                            stroke-width="0" fill-rule="evenodd" class="jvm-region jvm-element"></path>
                                        <path d="M504.86,320.38l0.39,0.01l0.27,-0.07l-0.3,0.35l-0.36,-0.28Z" data-code="XC"
                                            fill="#dee2e8" fill-opacity="1" stroke="none" stroke-width="0"
                                            fill-rule="evenodd" class="jvm-region jvm-element"></path>
                                        <path
                                        ...
                                        <path d="M436.07,271.5l-0.48,-0.1l0.29,-1.66l0.29,0.51l-0.1,1.25Z" data-code="LU"
                                            fill="#dee2e8" fill-opacity="1" stroke="none" stroke-width="0"
                                            fill-rule="evenodd" class="jvm-region jvm-element"></path>
                                        <path
                                    ...
                                    <g id="jvm-markers-group">
                                        <circle data-index="0" cx="456.2847921194732" cy="134.5871942936338" r="7"
                                            fill="#e91e63" fill-opacity="1" stroke="#FFF" stroke-width="5"
                                            stroke-opacity="0.5" class="jvm-marker jvm-element"></circle>
                                        <circle data-index="1" cx="550.8098108141878" cy="117.77618111649691" r="7"
                                            fill="E91E63" fill-opacity="1" stroke="#FFF" stroke-width="5"
                                            stroke-opacity="0.5" class="jvm-marker jvm-element"></circle>
                                        <circle data-index="2" cx="477.6656116628319" cy="192.7213602474008" r="7"
                                            fill="#e91e63" fill-opacity="1" stroke="#FFF" stroke-width="5"
                                            stroke-opacity="0.5" class="jvm-marker jvm-element"></circle>
                                        <circle data-index="3" cx="638.4969429475602" cy="94.97112314618349" r="7"
                                            fill="E91E63" fill-opacity="1" stroke="#FFF" stroke-width="5"
                                            stroke-opacity="0.5" class="jvm-marker jvm-element"></circle>
                                        <circle data-index="4" cx="665.5873592374048" cy="158.76794844934062" r="7"
                                            fill="#E91E63" fill-opacity="1" stroke="#FFF" stroke-width="5"
                                            stroke-opacity="0.5" class="jvm-marker jvm-element"></circle>
                                    </g>
                    ...
                    <div class="card z-index-2 ">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                <div class="chart">
                                    <canvas id="chart-bars" class="chart-canvas" height="170" width="702"
                                        style="display: block; box-sizing: border-box; height: 170px; width: 702px;"></canvas>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card z-index-2  ">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                            <div class="bg-gradient-success shadow-success border-radius-lg py-3 pe-1">
                                <div class="chart">
                                    <canvas id="chart-line" class="chart-canvas" height="170" width="702"
                                        style="display: block; box-sizing: border-box; height: 170px; width: 702px;"></canvas>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card z-index-2 ">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                            <div class="bg-gradient-dark shadow-dark border-radius-lg py-3 pe-1">
                                <div class="chart">
                                    <canvas id="chart-line-tasks" class="chart-canvas" height="170" width="702"
                                        style="display: block; box-sizing: border-box; height: 170px; width: 702px;"></canvas>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mt-5 mt-md-0">
                    <div class="card" data-animation="true">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            ...
                            <div class="colored-shadow"
                                style="background-image: url(&quot;../../assets/img/products/product-2-min.jpg&quot;);">
                            </div>
                        </div>
                        <div class="card-body text-center">
                            <div class="d-flex mt-n6 mx-auto">
                ...
                <div class="col-lg-4 mt-5 mt-lg-0">
                    <div class="card" data-animation="true">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            ...
                            <div class="colored-shadow"
                                style="background-image: url(&quot;../../assets/img/products/product-3-min.jpg&quot;);">
                            </div>
                        </div>
                        <div class="card-body text-center">
                            <div class="d-flex mt-n6 mx-auto">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between pb-0">
                                        <a href="{{ route('group.form_check') }}" class="btn btn-primary ">
